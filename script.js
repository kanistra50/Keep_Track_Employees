...
function MyController($scope) {
    ...
    $scope.editCard = function (card) { 
        ...
        console.log("START EDIT. Total number of elements- "+resource.length);
    };

    $scope.save = function () {
        if ( unique(index) ) {

                resource[index].name = $scope.tempCard.name;
                resource[index].contacts = $scope.tempCard.contacts;
                resource[index].day = $scope.tempCard.day;
                resource[index].timeBegin = $scope.tempCard.timeBegin;
                resource[index].timeEnd = $scope.tempCard.timeEnd;
        
                $scope.cards[index] = [resource[index].name, resource[index].timeBegin+' - '+ resource[index].timeEnd];
